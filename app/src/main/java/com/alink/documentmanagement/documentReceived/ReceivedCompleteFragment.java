...
public class ReceivedCompleteFragment extends BaseFragment implements DocumentReceivedInterface.IReceivedView {
    ...
    public static ReceivedCompleteFragment createInstance() {

        Bundle args = new Bundle();

        ReceivedCompleteFragment fragment = new ReceivedCompleteFragment();
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_received_complete;
    }
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        //presenter.getListIn(AppConfig.VB_hoanthanh);
        ...
        adapter = new ListDocumentReceivedAdapter(getActivity(), listDocument, new ListDocumentReceivedAdapter.IListAction() {
            ...
            public void onItemClicked(int position) {
                ...
                intent.putExtra(AppConfig.IS_COMPLETED, true);
