...
public class ReceivedCooperateFragment extends BaseFragment implements DocumentReceivedInterface.IReceivedView {
    ...
    public static ReceivedCooperateFragment createInstance() {

        Bundle args = new Bundle();

        ReceivedCooperateFragment fragment = new ReceivedCooperateFragment();
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_received_cooperate;
    }
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        //presenter.getListIn(AppConfig.VB_phoihop);
