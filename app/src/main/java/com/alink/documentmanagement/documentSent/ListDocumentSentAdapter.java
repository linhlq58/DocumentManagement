...
public class ListDocumentSentAdapter extends RecyclerView.Adapter<ListDocumentSentAdapter.DocumentViewHolder> {
    public Context context;
    public ArrayList<DocumentOut> listDocument;
    public IListAction iListAction;

    public ListDocumentSentAdapter(Context context, ArrayList<DocumentOut> listDocument, IListAction iListAction) {
    ...
    public class DocumentViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(DocumentOut document) {
