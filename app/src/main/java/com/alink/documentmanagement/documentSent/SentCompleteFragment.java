...
public class SentCompleteFragment extends BaseFragment implements DocumentSentInterface.ISentView {
    ...
    public static SentCompleteFragment createInstance() {

        Bundle args = new Bundle();

        SentCompleteFragment fragment = new SentCompleteFragment();
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        //presenter.getListOut(AppConfig.VB_hoanthanh);
