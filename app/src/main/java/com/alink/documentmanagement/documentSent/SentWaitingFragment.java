...
public class SentWaitingFragment extends BaseFragment implements DocumentSentInterface.ISentView {
    ...
    public static SentWaitingFragment createInstance() {

        Bundle args = new Bundle();

        SentWaitingFragment fragment = new SentWaitingFragment();
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        //presenter.getListOut(AppConfig.VB_choxuli);
