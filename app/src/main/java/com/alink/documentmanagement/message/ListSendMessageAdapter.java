...
public class ListSendMessageAdapter extends RecyclerView.Adapter<ListSendMessageAdapter.MessageViewHolder> {
    public Context context;
    public ArrayList<SendMessage> listMessage;
    public IListAction listener;

    public ListSendMessageAdapter(Context context, ArrayList<SendMessage> listMessage, IListAction listener) {
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(SendMessage message) {
            if (message == null) return;

            tvSender.setText("Tin nhắn đi");
